              ...
              <>
                ...
                <li>
                  <Link to={"/dashboard/manageClasses"}>
                    <SiGoogleclassroom className="text-2xl" /> Manage Classes
                  </Link>
                </li>
              </>
            ):<></> }
              ...
              <>
                <li>
                  <Link to={"/dashboard/addCourse"}>
                    <AiOutlineAppstoreAdd className="text-2xl" /> Add A Class
                  </Link>
                </li>
                <li>
                  <Link to={"/dashboard/courseCard"}>
              ...
              <>
                <li>
                  <Link to={"/dashboard/selectedClass"}>
                    <AiOutlineShoppingCart className="text-2xl" /> My Selected
                    Classes
                ...
                <li>
                  <Link to={"/dashboard/enrolledClass"}>
                    <AiTwotoneShopping className="text-2xl" /> My Enrolled
                    Classes
                  </Link>
                </li>
                <li>
